...
app.get('/', async (req, res) => {
  const scope = 'report:caffeine-consumption report:caffeine-metabolite-ratio report:motion-sickness report:beta-carotene report:blood-glucose report:calcium report:carbohydrate-intake report:folate report:iron report:magnesium report:phosphorus report:protein-intake report:vitamin-a report:vitamin-b12 report:vitamin-d report:vitamin-e';
